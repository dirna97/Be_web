...
def sidebar(num_page, chemin='',admin=0):
    ...
    <div class="sidebar">
        <div class="scrollbar-inner sidebar-wrapper">
            <div class="user">
                <div class="photo">
					<img src="'''+chemin+'''/img/concentric-circles.png">
                </div>
                <div class="info">
                    ...
                    <div class="collapse in" id="collapseExample" aria-expanded="true" style="">
                        <ul class="nav">
                            ...
                            <li>
                                <a href="#settings">
                                    <span class="link-collapse">Modifier mon mot de passe</span>
                                </a>
                            </li>
                        </ul>
                    </div>
...
def footer(chemin=''):
    ...
    <script src=" ''' + chemin + '''/assets/js/ajouter_eq.js"></script>
